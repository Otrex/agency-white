<template> 
  <nav id="nav" class="w-full relative h-[8.5rem]">
    <div class="fixed w-full z-[100] inset-0 bottom-auto bg-white py-[1.6rem]">
      <div class="flex b-wrapper justify-between">
        ...
        <div class="flex items-center">
          <a href="#consult" class="b-btn accent sm">Contact Us</a>
